            ...
            <footer className="text-gray-600 body-font bg-gray-500 border-t-2">
                <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                        <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                            <span className="ml-3 text-xl text-black  hover:text-white"> <span className='text-5xl font-extrabold text-purple-800'>L</span>atest News.</span>
                        </a>
                    </div>
                    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10">
                                <li>
                                    <a className="text-white ">About latest news</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a className="text-white ">latest news Science</a>
                                </li>
                            </nav>
                        </div>
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10">
                                <li>
                                    <a className="text-white">Sell on latest newse</a>
                                </li>
                                <li>
                                    <a className="text-white ">sell under latest news Acecelerator </a>
                                </li>
                                <li>
                                    <a className="text-white">supply to latest news</a>
                                </li>
                                <li>
                ...
                <div className="bg-gray-500">
                    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                        <p className="text-black text-sm text-center sm:text-left">© 2020 Latest news. — @latest nesw
                        </p>
